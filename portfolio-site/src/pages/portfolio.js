export function renderPortfolio() {
  return `
    <div class="page-container">
      <div class="gallery">
        <a href="#/art" class="gallery-item" onclick="window.location.hash='#/art'; return false;">
          <img 
          ...
          />
          <div class="gallery-item-title">Art</div>
        </a>
        
        <a href="#/curation" class="gallery-item" onclick="window.location.hash='#/curation'; return false;">
          <img 
          ...
          />
          <div class="gallery-item-title">Curation</div>
        </a>
        
        <a href="#/writing" class="gallery-item" onclick="window.location.hash='#/writing'; return false;">
          <img 
          ...
          />
          <div class="gallery-item-title">Writing</div>
        </a>
      </div>
    </div>
  `
